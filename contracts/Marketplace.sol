...
contract Marketplace {
    ...
    uint256 constant public PRESALE_PRICE = 50;
    uint256 constant public PRESALE_SUPPLY = 100;
    uint256 constant public PUBLICSALE_PRICE = 25;
    uint256 constant public PUBLICSALE_SUPPLY = 25;
    uint256 constant public NFTS_PER_WALLET = 4;
    ...
    constructor(address _rewardToken, address _nft, address _wallet) {
        ...
        saleStat = "presale";
        preSale.price = PRESALE_PRICE * decimal();
        preSale.totalSupply = PRESALE_SUPPLY;
        publicSale.price = PUBLICSALE_PRICE * decimal();
        publicSale.totalSupply = PUBLICSALE_SUPPLY;
    ...
    function mint(address _user, uint256 _mintAmount) public {
        require(nft.balanceOf(msg.sender) + _mintAmount <= NFTS_PER_WALLET-1, "Cannot mint more that 3 NFTs with normal rarities");
    ...
    function mintDiamond(address _user) public {   
        require(nft.balanceOf(msg.sender) == NFTS_PER_WALLET-1, "Not eligible for Diamond");
